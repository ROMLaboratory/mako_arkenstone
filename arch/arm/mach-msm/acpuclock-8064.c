...
//	[0]  = { {  378000, HFPLL, 2, 0x1C },  945000, 1000000, 1 },
	[1]  = { {  384000, PLL_8, 0, 0x00 },  945000, 1000000, 1 },
	[2]  = { {  432000, HFPLL, 2, 0x20 }, 1050000, 1000000, 2 },
	[3]  = { {  486000, HFPLL, 2, 0x24 }, 1050000, 1000000, 2 },
	[4]  = { {  540000, HFPLL, 2, 0x28 }, 1050000, 1000000, 2 },
	[5]  = { {  594000, HFPLL, 1, 0x16 }, 1050000, 1000000, 2 },
	[6]  = { {  648000, HFPLL, 1, 0x18 }, 1050000, 1000000, 4 },
	[7]  = { {  702000, HFPLL, 1, 0x1A }, 1150000, 1100000, 4 },
	[8]  = { {  756000, HFPLL, 1, 0x1C }, 1150000, 1100000, 4 },
	[9]  = { {  810000, HFPLL, 1, 0x1E }, 1150000, 1100000, 4 },
	[10] = { {  864000, HFPLL, 1, 0x20 }, 1150000, 1100000, 4 },
	[11] = { {  918000, HFPLL, 1, 0x22 }, 1150000, 1100000, 5 },
	[12] = { {  972000, HFPLL, 1, 0x24 }, 1150000, 1100000, 5 },
	[13] = { { 1026000, HFPLL, 1, 0x26 }, 1150000, 1100000, 5 },
	[14] = { { 1080000, HFPLL, 1, 0x28 }, 1150000, 1100000, 5 },
	[15] = { { 1134000, HFPLL, 1, 0x2A }, 1150000, 1100000, 5 },
#else
...
static struct acpu_level tbl_slow[] __initdata = {
#ifdef CONFIG_LOW_CPUCLOCKS
	{ 1, {    27000, HFPLL, 2, 0x02 }, L2(0),   750000 },
	...
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(L2_BW_MID), 1025000 },
	{ 0, {   756000, HFPLL, 1, 0x1C }, L2(L2_BW_MID), 1075000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(L2_BW_MID), 1075000 },
	{ 0, {   864000, HFPLL, 1, 0x20 }, L2(L2_BW_MID), 1100000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(L2_BW_MID), 1100000 },
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(L2_BW_MID), 1125000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(L2_BW_MID), 1125000 },
	...
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(17), 1425000 },
	{ 1, {  1917000, HFPLL, 1, 0x47 }, L2(17), 1450000 },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_nom[] __initdata = {
	...
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(L2_BW_MID),  975000 },
	{ 0, {   756000, HFPLL, 1, 0x1C }, L2(L2_BW_MID), 1025000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(L2_BW_MID), 1025000 },
	{ 0, {   864000, HFPLL, 1, 0x20 }, L2(L2_BW_MID), 1050000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(L2_BW_MID), 1050000 },
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(L2_BW_MID), 1075000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(L2_BW_MID), 1075000 },
	...
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(17), 1350000 },
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(17), 1375000 },
	{ 1, {  1917000, HFPLL, 1, 0x47 }, L2(17), 1400000 },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_fast[] __initdata = {
	...
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(L2_BW_MID),  925000 },
	{ 0, {   756000, HFPLL, 1, 0x1C }, L2(L2_BW_MID),  975000 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(L2_BW_MID),  975000 },
	{ 0, {   864000, HFPLL, 1, 0x20 }, L2(L2_BW_MID), 1000000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(L2_BW_MID), 1000000 },
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(L2_BW_MID), 1025000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(L2_BW_MID), 1025000 },
	...
	{ 1, {  1917000, HFPLL, 1, 0x47 }, L2(17), 1350000 },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_faster[] __initdata = {
	...
	{ 0, {   648000, HFPLL, 1, 0x18 }, L2(L2_BW_MID),   925000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(L2_BW_MID),  925000 },
	{ 0, {   756000, HFPLL, 1, 0x1C }, L2(L2_BW_MID),  962500 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(L2_BW_MID),  962500 },
	{ 0, {   864000, HFPLL, 1, 0x20 }, L2(L2_BW_MID),  975000 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(L2_BW_MID),  975000 },
	{ 0, {   972000, HFPLL, 1, 0x24 }, L2(L2_BW_MID), 1000000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(L2_BW_MID), 1000000 },
	...
	{ 1, {  1863000, HFPLL, 1, 0x44 }, L2(17), 1250000 },
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(17), 1275000 },
	{ 1, {  1917000, HFPLL, 1, 0x47 }, L2(17), 1300000 },
#endif
	{ 0, { 0 } }
};
