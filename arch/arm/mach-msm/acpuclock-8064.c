...
static struct acpu_level tbl_slow[] __initdata = {
	...
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(15), 1425000 },
	{ 1, {  1944000, HFPLL, 1, 0x48 }, L2(15), 1450000 },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_nom[] __initdata = {
	...
	{ 1, {  1944000, HFPLL, 1, 0x48 }, L2(15), 1400000 },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_fast[] __initdata = {
	...
	{ 1, {  1944000, HFPLL, 1, 0x48 }, L2(15), 1350000 },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_faster[] __initdata = {
	...
	{ 1, {  1863000, HFPLL, 1, 0x44 }, L2(15), 1250000 },
